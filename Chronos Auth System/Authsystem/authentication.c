...
u8 key_ap[16]={0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F}; //AP Key
u8 key_watch[16]={0xA1,0xB2,0xC3,0xD4,0xE5,0xF1,0xA4,0x42,0x55,0x16,0x17,0x78,0x99,0x12,0x55,0x20}; //Client Key
